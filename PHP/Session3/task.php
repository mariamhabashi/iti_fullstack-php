...
if (isset($_POST['register']) && empty($name_error) && empty($email_error) && empty($age_error) && empty($languages_error)) {
    $userData = [
        'Name' => $name,
        'Email' => $email,
        'Age' => $age,
...
<body>
    ...
    <form action="task.php" method="POST">
        ...
        <input type="text" id="name" name="name"
            value="<?php echo $name; ?>"><br><?php $name_error ? print ('<span style="color:red; font-weight: bold">' . $name_error . '</span>') : ''; ?>
        <br><br>

        <label for="email">Email</label><br>
        <input type="email" id="email" name="email"
            value="<?php echo $email; ?>"><br><?php $email_error ? print ('<span style="color:red; font-weight: bold">' . $email_error . '</span>') : ''; ?>
        <br><br>

        <label for="age">Age</label><br>
        <input type="number" id="age" name="age"
            value="<?php echo $age; ?>"><br><?php $age_error ? print ('<span style="color:red; font-weight: bold">' . $age_error . '</span>') : ''; ?>
        <br><br>
        ...
        <select id="country" name="country">
            ...
            <option value="Saudi Arbya" <?php if ($country == 'Saudi Arbya')
                echo 'selected'; ?>>Saudi Arbya</option>
            <option value="United Arab Emirates" <?php if ($country == 'United Arab Emirates')
                echo 'selected'; ?>>United
                Arab Emirates</option>
            <option value="Jordon" <?php if ($country == 'Jordon')
                echo 'selected'; ?>>Jordon</option>
        </select>
        <br><br>
